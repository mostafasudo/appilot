...
describe("ContactPanel", () => {
  it("directs users to email, Discord, and scheduling time", () => {
    ...
    expect(screen.getByText("For all support inquiries, email us at abdel@appilot.ai or join our Discord or book a call.")).not.toBeNull()
    expect(screen.getByRole("link", { name: "Email support" })).toHaveAttribute("href", "mailto:abdel@appilot.ai")
